...
public class AdminService {
    ...
    public AdminResponseDTO criarAdmin (ClienteCadastroDTO cliente){
        ...
        if (cliente.getRua() == null || cliente.getRua().isBlank()){
            throw new RegradeNegocioException("Endereço obrigatório: Rua");
        }
        if (cliente.getNumero() == null){
            throw new RegradeNegocioException("Endereço obrigatório: Número");
        }
        if (cliente.getBairro() == null || cliente.getBairro().isBlank()){
            throw new RegradeNegocioException("Endereço obrigatório: Bairro");
        }
        if (cliente.getCidade() == null || cliente.getCidade().isBlank()){
            throw new RegradeNegocioException("Endereço obrigatório: Cidade");
        }
        ...
        if (cliente.getComplemento() == null || cliente.getComplemento().isBlank()){
            throw new RegradeNegocioException("Endereço obrigatório: Complemento");
        }
